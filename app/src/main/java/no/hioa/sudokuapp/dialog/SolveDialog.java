 ...
 *
 * DialogFragment that asks user if they want to solve the sudoku
 */
public class SolveDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ((SudokuActivity) getActivity()).solve();
                        break;
        ...
        alertDialogBuilder.setTitle(context.getResources().getString(R.string.solve))
                .setMessage(context.getResources().getString(R.string.solve_dialog))
